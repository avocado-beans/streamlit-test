...
st.write("**But the goal is to make software that can be used not only to save and protect ecosystems, but to :green[**enhance**] them, make them :green[**stronger**] and more :green[**efficient.**] It's based on the (almost-baseless, I admit) assumption that nature doesn't need to be constantly bombarded with fertilizers or :red['care and protection'] procedures (such as terracing or drone-watering) in order to yield food long-term.**")
