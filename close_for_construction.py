...
st.set_page_config(page_title="Closed For Construction | Plantr.", page_icon="🌿")

st.title("Super sorry, dude! :green[Plantr] is temporarily down for :green[maintainance] and :green[development!] 🛠️")
...
st.divider()
st.write("**If you're talking about the name, I genuinely have no clue. It was a placeholder at first but then it just stuck, I guess.**")
...
st.subheader(":green[**_Ecosystems can fully sustain themselves_**] **_while also providing abundant food, but only if the organisms that consitute them_** :green[**_interact with each other in very specific ways._**]")
