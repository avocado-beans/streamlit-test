...
st.subheader(":green[**_Ecosystems can fully sustain themselves_**] **_while also providing abundant food, but only if the organisms that consitute them** :green[**interact with each other in very specific ways._**]")
