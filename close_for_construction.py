...
st.subheader(":green[**Ecosystems can fully sustain themselves**] **while also providing abundant food, but only if the organisms that consitute them** :green[**interact with each other in very specific ways.**]")
